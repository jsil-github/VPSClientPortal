<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChangeAllocation.aspx.cs" Inherits="ChangeAllocation" %>
 ...
 <div class="card-header mt-5">
                    ...
                    <asp:GridView ID="GridView2"  CssClass="table table-hover text-nowrap" runat="server" Width="100%" AutoGenerateColumns="False" BorderStyle="None" Font-Size="10pt" OnRowDataBound="GridView2_ItemDataBound"  >
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="FundType" HeaderText="FUND" >
						...
						<div class="col-md-10 p-2">
                            <h3 class="text-dark font-weight-bold mb-2">Allocation Deatils</h3>
                                <div class="card h-auto">
                                   ...
                                   <table class="table table-hover text-nowrap">
                                    <thead>
                                        <tr>
                                            <th style="font:bold !important">Allocation Type</th>
                                            <th style="font:bold !important">Range</th>
                                            <th style="font:bold !important">Percentage (%)</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    <asp:TextBox Text="0-100" Enabled="false" BorderWidth="1px" runat="server" TextMode="SingleLine"></asp:TextBox>
        ...
        ControlToValidate="totalTaxable1" 
        ValidationGroup='Taxation'
        ForeColor="Red" 
        ErrorMessage="Please enter a number between 0 and 100."
        ValidationExpression="^([0-9]|[1-9][0-9]|100)$"
        Display="Dynamic" 
        runat="server" />
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="input-group">
                                                    ...
                                                    <asp:Label  Text="Money Market" runat="server"></asp:Label>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-group">
        ...
        ControlToValidate="totalTaxable2" 
        ValidationGroup='Taxation'
        ForeColor="Red" 
        ErrorMessage="Please enter a number between 0 and 100."
        ValidationExpression="^([0-9]|[1-9][0-9]|100)$"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="input-group">
                                                    ...
                                                    <asp:Label  Text="Debt" runat="server"></asp:Label>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-group">
        ...
        ControlToValidate="totalTaxable3" 
        ValidationGroup='Taxation'
        ForeColor="Red" 
        ErrorMessage="Please enter a number between 0 and 100."
        ValidationExpression="^([0-9]|[1-9][0-9]|100)$"

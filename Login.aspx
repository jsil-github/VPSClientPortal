<%@ Page Language="C#" AutoEventWireup="true" enableEventValidation="true" CodeFile="Login.aspx.cs" Inherits="Login" %>
      ...
      <div class="content-wrapper d-flex align-items-stretch auth auth-img-bg">
        <div class="row flex-grow">
          <div class="col-lg-4 d-flex align-items-center justify-content-center mydiv" style="background-color:#f57d20">
            ...
            <div class="col-sm-12 text-center pb-4" style="
    padding-top: 1.9rem;
">
                
            <img src="images/logo.png" alt="Example image" class="img-responsive img-fluid" style="
    height: 45px;
">
            </div>
...
"></i>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <div class="input-group-prepend bg-transparent" style="
    
">
                      <span class="input-group-text bg-transparent border-right-0" style="
...
"></i>
                       ...
                       <asp:TextBox ID="txtPassword" TextMode="Password" class="form-control border-left-0" data-toggle="tooltip" title="Password is required!" maxlength="50"  required  placeholder="Password" runat="server"></asp:TextBox>
                    <%--<input type="password" class="form-control border-left-0" id="exampleInputPassword" placeholder="Password" >  --%>                      
                  </div>
                </div>
                <div class="my-2 d-flex justify-content-between align-items-center">
                  <div class="form-check">
                    ...
                    <%--data-toggle="modal" data-target="#exampleModal"--%>
                      <a class="text-decoration-underline text-primary" style="cursor: pointer;" href="ForgetPassword.aspx">Forgot Password?</a>
                    
                  </div>
                  <%--<a href="#" class="auth-link text-black">Forgot password?</a>--%>
                </div>
                <div class="my-3">
                    <asp:Button ID="btnLogin" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn col-12" runat="server" Text="Sign In" OnClick="btnLogin_Click" />
